...
return {
  {
    ...
    event = "LspAttach", -- Lädt erst, wenn ein LSP aktiv ist
    opts = {
    ...
    --
    --     if symbol.references then
    --       local count = symbol.references > 0 and ("   " .. symbol.references) or "   0"
    --       table.insert(ins, { count, "SymbolUsageContent" })
    --     end
    --
    --     if symbol.definition then
    --       if #ins > 0 then
    --         table.insert(ins, { " ", "NonText" })
    --       end
    --       table.insert(ins, { "   " .. symbol.definition, "SymbolUsageContent" })
    --     end
    --
    --     return ins
    --   end,
    --   vt_position = "end_of_line", -- Erzwingt die Anzeige am Zeilenende
    --   disable = {
    --     lsp = { "jdtls" }, -- Optional: Verhindert Konflikte, falls jdtls doppelt sendet
    --   },
    --   filetypes = {
    --     java = {
    --       -- Spezifische Symbole für Java, die getrackt werden sollen
    --       kinds = { "Method", "Constructor", "Class", "Interface" },
    --     },
    --   },
    -- },
  },
